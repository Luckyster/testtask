 ...
 */
const baseDir = 'http://localhost:10003/'
...
// Process scripts.
function scripts(){
	return src( ['src/js/filters.js'], {base: 'src'} )		// Get main js file to process it.
		...
		.pipe( concat( 'filters.min.js' ) )	// Conact in one file main.min.js.
...
function buildScripts(){
	return src( ['src/js/filter.js'] )		// Get main js file to process it.
		.pipe( rollup(
			{
				plugins: [
					babel(),
